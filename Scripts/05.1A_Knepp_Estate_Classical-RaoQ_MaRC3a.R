###############################################################################
# 05.1A_Knepp_Estate_Classical-RaoQ_MaRC3a
...
# Directories
tile_dir <- file.path("/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Knepp Estate", paste0("Knepp_", year, "_MeanNDVI_Tiles"))
