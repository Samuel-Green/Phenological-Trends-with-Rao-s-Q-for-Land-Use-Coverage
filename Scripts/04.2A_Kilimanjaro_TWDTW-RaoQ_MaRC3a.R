###############################################################################
# 04.2A_Kilimanjaro_TWDTW-RaoQ_MaRC3a
# Processes ONE tile for TWDTW Rao's Q (PPI & SG Filtered)
###############################################################################
...
tile_dir <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro/Timeseries_PPI_Kili_SG_Tiles"
out_dir  <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro/TWDTWPPI_Rao-utputs"

dir.create(out_dir, showWarnings = FALSE, recursive = TRUE)

tile_file <- file.path(
  tile_dir,
  paste0("KiliNP-SG_TimeseriesPPI_Tile-", tile_id, ".tif")
)
...
out_file <- file.path(
  out_dir,
  paste0("KiliNP_PPI_TWDTW-RaoQ_SG_Tile-", tile_id, ".tif")
)
