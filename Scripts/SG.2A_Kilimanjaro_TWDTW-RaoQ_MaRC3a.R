###############################################################################
# SG.2A_Kilimanjaro_TWDTW-RaoQ_MaRC3a
# Processes ONE tile for TWDTW Rao's Q (SG Filtered)
###############################################################################
...
tile_dir <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro_SG_Test/Timeseries_SG_NDVI_tiles"
out_dir  <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro_SG_Test/TWDTW_SG_Rao-utputs"

dir.create(out_dir, showWarnings = FALSE, recursive = TRUE)

tile_file <- file.path(
  tile_dir,
  paste0("KiliNP_SG_2017-2021_NDVI_Tile-", tile_id, ".tif")
)
...
out_file <- file.path(
  out_dir,
  paste0("KiliNP_2017-2021_TWDTW-RaoQ_SG_Tile-", tile_id, ".tif")
)
