###############################################################################
# 06.2A_Knepp_Estate_TWDTW-RaoQ_MaRC3a
...
# Directories
tile_dir <- file.path("/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Knepp Estate", paste0("Knepp_", year, "_PPI_Timeseries_Tiles"))
...
dynamic_dates_string <- paste0(sub("_PPI$", "", current_names), "-15")
