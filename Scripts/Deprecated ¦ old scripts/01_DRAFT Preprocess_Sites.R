...
# Optional tidy up
rm(tmp.landsat_raster,
   tmp.knepp_AoI_projected,
   tmp.knepp_raster_cropped,
   tmp.knepp_cropped_filename) # I can run this if I want to clean up my workspace and avoid too many objects

### Macchia Sacra Preprocessing ####
...
### Kilimanjaro National Park Preprocessing ####
