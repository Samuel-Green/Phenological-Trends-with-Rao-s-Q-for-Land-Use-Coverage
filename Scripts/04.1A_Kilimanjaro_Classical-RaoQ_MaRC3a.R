###############################################################################
# 04.1A_Kilimanjaro_Classical-RaoQ_MaRC3a
# Processes ONE tile for classical Rao's Q (PPI & SG Filtered)
###############################################################################
...
tile_dir <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro/Mean_PPI_Kili_SG_Tiles"
out_dir  <- "/home/shayle/TWDTW Paper (B3 Hackathon Postprint)/Data/Processed Data/Kilimanjaro/MeanPPI_Rao-utputs"

dir.create(out_dir, showWarnings = FALSE, recursive = TRUE)

tile_file <- file.path(
  tile_dir,
  paste0("KiliNP-SG_MeanPPI_Tile-", tile_id, ".tif")
)
...
out_file <- file.path(
  out_dir,
  paste0("KiliNP_PPI_Classic-RaoQ_SG_Tile-", tile_id, ".tif")
)
